...
python -m pytest
```
Current baseline in this repository (validated on February 26, 2026): `778 passed, 2 skipped` on `python -m pytest tests -q`; skip counts can vary by environment (for example Tcl/Tk availability).
