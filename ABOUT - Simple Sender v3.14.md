...
This document summarizes the current stable `3.14` release baseline.

**Simple Sender v3.14** is a GRBL 1.1h g-code sender built for practical, real-world CNC use. Rather than focusing on flashy presentation or unnecessary complexity, it is designed to provide a dependable, operator-friendly workflow that works well in an actual shop environment.
