...
def build_interface_section(app, parent: ttk.Frame, row: int) -> int:
    ...
    indicator_row.grid(row=6, column=0, sticky="w", pady=(2, 0))
    ...
    quick_buttons_label.grid(row=7, column=0, sticky="w", pady=(10, 0))
    quick_buttons_row = ttk.Frame(interface_frame)
    quick_buttons_row.grid(row=8, column=0, sticky="w", pady=(2, 0))
    ...
    toggle_btn_row.grid(row=9, column=0, sticky="w", pady=(10, 0))
