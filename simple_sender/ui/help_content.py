        ...
        subsections=(
            ...
            _sub(
                ...
                bullets=(
                    ...
                    "Path View uses bounded batch/LOD geometry for large jobs, keeps the Machine Travel Area as context when available, and reports Preview Limited when the displayed path is reduced or geometry-affecting commands cannot be represented. Displayed travel area, preview state, and marker state do not feed back into motion control, limit handling, streaming, probing, recovery, or completion logic.",
