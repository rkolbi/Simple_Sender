        ...
        subsections=(
            ...
            _sub(
                ...
                bullets=(
                    ...
                    "Path View uses bounded batch/LOD geometry for large jobs, offers low/medium/high/maximum bounded source-detail levels, can list inferred tool-change sections for display-only selection, keeps the Machine Travel Area as context when available, and reports Preview Limited when the displayed path is reduced, file-backed source lines are sampled, or geometry-affecting commands cannot be represented. Tool-change inference is not authoritative controller state. Sampled previews are approximate and are not complete toolpaths. Displayed travel area, preview state, and marker state do not feed back into motion control, limit handling, streaming, probing, recovery, or completion logic.",
        ...
        subsections=(
            ...
            _sub(
                ...
                bullets=(
                    ...
                    "The supported streamed TC: safety behavior assumes files generated by the bundled Simple-Sender Vectric posts.",
                    "The Simple-Sender posts emit VACUUM_OFF, M5, and TC:[TOOLNAME] before tool-change prompts, then [S]M3, dwell, and VACUUM_ON in the new segment.",
                    "Simple Sender intercepts TC: lines, pauses streaming, runs the built-in Tool Change workflow, and then resumes streaming.",
                    "Hand-written or custom TC: files are not fully validated for equivalent spindle, vacuum, and restart sequencing.",
        ...
        subsections=(
            ...
            _sub(
                ...
                bullets=(
                    ...
                    "Shows quick-scan metrics, dimensions, estimate, and separate Toolpaths and Tools Required lists when metadata provides them.",
            ...
            _sub(
                ...
                bullets=(
                    ...
                    "If it was opened from App Settings, Macro Manager stays above that popup and closing it leaves App Settings open.",
                ),
            ),
            _sub(
                "Macro Prompt Dialog",
