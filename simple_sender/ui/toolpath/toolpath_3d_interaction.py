...
class Toolpath3DInteractionMixin:
    ...
    pan_x: float
    pan_y: float
    _drag_start: tuple[int, int] | None
    _pan_start: tuple[int, int] | None
    _fast_mode: bool
    _fast_mode_after_id: Any
    _fast_mode_duration: float
    on_save_view: Callable[[], Any] | None
    on_load_view: Callable[[], Any] | None
