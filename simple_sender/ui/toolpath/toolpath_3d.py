...
class Toolpath3D(Toolpath3DDataMixin, Toolpath3DRenderMixin, Toolpath3DInteractionMixin, ttk.Frame):
    def __init__(
        ...
        self._perf_frame: ttk.Frame | None = None
        self._perf_scale: ttk.Scale | None = None
        self._perf_value_label: ttk.Label | None = None
        ...
        self._pending_parsed: Any | None = None
        self._parse_token = 0
        ...
        self._arc_step_override_rad: float | None = None
        ...
        self._last_segments: list[tuple[float, float, float, float, float, float, str]] | None = None
        self._last_bounds: tuple[float, float, float, float, float, float] | None = None
        ...
        self._last_gcode_lines: list[str] | None = None
        self._full_parse_skipped = False
        self._streaming_mode = False
        self._streaming_prev_render_interval: float | None = None
